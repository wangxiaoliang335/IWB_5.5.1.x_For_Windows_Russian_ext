...
//	SMR_AddDataBlock((char*)CT2A(m_str), (char*)CT2A(m_Vstr),128);

	SMR_Write((char*)CT2A(m_str), (char*)CT2A(m_Vstr), (unsigned char*)(char*)CT2A(m_TempEdit),m_TempEdit.GetLength(),0,0);
