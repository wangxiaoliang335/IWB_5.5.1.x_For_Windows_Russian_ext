...
{
    // Delete the pins
	NOTE("CTransformFilter::~CTransformFilter");
...
{
	NOTE("CTransformFilter::Transform");
...
{
	NOTE("CTransformFilter::StartStreaming");
    return NOERROR;
}
...
{
	NOTE("CTransformFilter::StopStreaming");
    return NOERROR;
}
...
{
	NOTE("CTransformFilter::CheckConnect");
...
{
	NOTE("CTransformFilter::BreakConnect");
    UNREFERENCED_PARAMETER(dir);
    return NOERROR;
}
...
{
	NOTE("CTransformFilter::CompleteConnect");
...
{
	NOTE("CTransformFilter::EndOfStream");
    HRESULT hr = NOERROR;
    if (m_pOutput != NULL) {
...
{
	NOTE("CTransformFilter::BeginFlush");
    HRESULT hr = NOERROR;
    if (m_pOutput != NULL) {
...
{
	NOTE("CTransformFilter::EndFlush");
...
CTransformFilter::NewSegment(
    ...
    double dRate)
{
	NOTE("CTransformFilter::DeliverNewSegment");
    if (m_pOutput != NULL) {
...
{
	//NOTE("CTransformFilter::CheckStreaming");
