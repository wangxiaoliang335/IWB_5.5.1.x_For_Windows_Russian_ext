#pragma once
#ifdef OPTICALPEN_INTERFACE_EXPORTS
	#define  OPTICAL_PEN_API _declspec(dllexport)
#else
	#define OPTICAL_PEN_API _declspec(dllimport)
#endif
...
//      
OPTICAL_PEN_API UINT OPI_PleaseNotifyMe(HWND hWnd = NULL);
...
//  
OPTICAL_PEN_API BOOL OPI_StopNotifyMe(HWND hWnd = NULL);
