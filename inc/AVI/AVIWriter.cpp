...
BOOL CAviWriter::OpenFile(LPCTSTR lpszFileName, int nYUY2Width, int nYUY2Height, DWORD dwRate, DWORD dwFourCC)
{
	HRESULT ret;
	...
	YUVFmt.biCompression = dwFourCC;
	//YUVFmt.biCompression = MJPG;
